// Package flowtoken is a request flow controller, it can control request traffic
// and adjust the flow threshold automatically based on success rate per second.
package flowtoken
